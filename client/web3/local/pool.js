...
export const getPoolInfo = async () => {
    ...
    const latestFeedPrice = await pool.latestFeedPrice.call()
    const latestFeedTimestamp = await pool.latestFeedTimestamp.call()
...
export const getPortfolioInfo = async () => {
    ...
    const deposited = await pool.getDeposits.call( {from: account} )
    const withdrawn = await pool.getWithdrawals.call( {from: account} )
