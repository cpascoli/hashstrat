...
export const getAllowance = async () => {
    const account = await getAccount()
    const usdcp = await getInstance()
    const decimals = await usdcp.methods.decimals().call()
    const allowance = await usdcp.methods.allowance(account, pool_conctract_address).call()
...
export const approve = async (amount) => {
    ...
    return new Promise((resolve, reject) => {
       usdcp.methods.approve(pool_conctract_address, tokenDecimals)
        .send({
            from: account,
...
export const symbol = async() => {
    const usdcp = await getInstance()
    const response = await usdcp.methods.symbol().call()
    return response
}
